...
# random intercept for pond
library(lme4)
mod1 <- lme4::glmer(sample.collected ~ 
                brushes + 
                beaver.feature +
                #days.between.checks.std.mod.1 +
                n.crossed.snare_beaver.std.mod.1 + 
                n.crossed.snare_other.std.mod.1 + (1|hair.snare.id), 
                data = hair.for.model,
            family = binomial(),
